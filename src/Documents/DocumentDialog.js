...
class DocumentDialog extends React.Component {
    texts = {
        ...
        'Реквизиты:\n' +
        'ИП Шипин Алексей Станиславович ИНН 744717969954 / ОГРНИП 317502700058822,\n' +
        'Тел./факс: 8-906-018-0010',
        'about': 'Студия растяжки Stretch&go',
        'refund': 'Оплата является авансовой и возврату не подлежит',
        'contract': 'ИП Шипин А. С.   (ОГРНИП 317502700058822), действующий на основании Свидетельства о государственной регистрации юридического лица, именуемый в дальнейшем Студия  растяжки Stretch and Go (далее - Студия), с одной стороны, и Клиент, с другой стороны, далее совместно именуемые Стороны, заключили настоящий Договор о нижеследующем:\n' +
        '\n' +
